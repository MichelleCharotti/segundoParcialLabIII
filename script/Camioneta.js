...
(function (general) {
    var Camioneta = /** @class */ (function (_super) {
        ...
        Camioneta.guardarCamioneta = function (id, marca, modelo, precio, cuatroXcuatro) {
            var nuevoCamioneta = new Camioneta(id, marca, modelo, precio, cuatroXcuatro);
            general.listaVehiculos.push(nuevoCamioneta);
